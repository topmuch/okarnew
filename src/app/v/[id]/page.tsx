    ...
    <div className="min-h-screen bg-[#F8FAFC] pb-32">
      ...
      `}>
        ...
        <div className="bg-white rounded-3xl shadow-sm shadow-gray-100 border border-gray-100/50 overflow-hidden">
          ...
          {/* Bouton voir plus */}
          <button className="w-full p-4 flex items-center justify-center gap-2 bg-gradient-to-r from-gray-50 to-gray-100/50 text-gray-700 font-semibold text-sm border-t border-gray-100 active:bg-gray-100 transition-colors">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-30 bg-white/95 backdrop-blur-xl border-t border-gray-100 p-4 pb-6">
        <div className="max-w-lg mx-auto space-y-3">
          ...
          <button className="w-full py-4 rounded-2xl font-bold text-white text-base bg-gradient-to-r from-orange-500 via-rose-500 to-pink-500 shadow-lg shadow-rose-500/30 flex items-center justify-center gap-2 active:scale-95 transition-transform">
            <Download className="w-5 h-5" />
            <span>Acheter le Rapport Complet (1 000 FCFA)</span>
          </button>
          
          {/* Bouton secondaire */}
          <button className="w-full py-3 rounded-2xl font-semibold text-gray-600 text-sm bg-gray-100 border border-gray-200 flex items-center justify-center gap-2 active:bg-gray-200 transition-colors">
