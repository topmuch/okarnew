      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 via-pink-50 to-blue-50 flex items-center justify-center p-4">
        <Card className="max-w-md w-full border-0 shadow-xl">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-gray-600 mb-2">{error || 'Ce QR code n\'existe pas ou a été désactivé.'}</p>
            {errorHint && (
            ...
            <CardContent className="pt-4">
              <form onSubmit={handleActivate} className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  {photoPreview ? (
                    <div className="relative w-full h-48 rounded-xl overflow-hidden border-2 border-pink-200">
                      <img
                        src={photoPreview}
                    ...
                    <label className="flex flex-col items-center justify-center w-full h-48 border-2 border-dashed border-gray-300 rounded-xl cursor-pointer hover:border-pink-400 hover:bg-pink-50/50 transition-all">
                      <div className="flex flex-col items-center justify-center pt-5 pb-6">
                        <Camera className="w-10 h-10 text-gray-400 mb-3" />
                        <p className="mb-2 text-sm text-gray-500">
                          <span className="font-semibold text-pink-600">Cliquez pour ajouter</span> une photo
                        </p>
