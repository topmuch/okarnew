 ...
 * 
 * CORRIGÉ: URLs Google Maps avec coordonnées GPS réelles
 */
...
import { generateGoogleMapsUrl, formatDistance } from '@/lib/mapsHelper'
    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {garages.map((garage, index) => {
          // Générer l'URL Google Maps avec les coordonnées réelles
          const mapsUrl = generateGoogleMapsUrl(
            garage.latitude,
            garage.longitude,
            null, // place_id non disponible
            garage.address ? `${garage.address}, ${garage.city}` : null,
            garage.name
          )
                ...
                <div className="flex gap-2">
                  ...
                  >
                    <a 
                      ...
                      title={`Itinéraire vers ${garage.name}`}
                    >
